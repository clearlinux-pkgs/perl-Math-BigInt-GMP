...
Source0  : https://cpan.metacpan.org/authors/id/P/PJ/PJACKLAM/Math-BigInt-GMP-1.6008.tar.gz
Summary  : unknown
...
%prep
%setup -q -n Math-BigInt-GMP-1.6008
cd %{_builddir}/Math-BigInt-GMP-1.6008
